# apify-actor-task — Claude Code Agent Skill

An Agent Skill **for Claude** (Claude Code / claude.ai). **Target LLM: Claude.**

**→ The skill lives in [`skills/apify-actor-task/`](skills/apify-actor-task/).** Copy that folder into your `~/.claude/skills/` directory.
